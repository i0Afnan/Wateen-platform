...
const SetBasicInfo2 = () => {
  ...
  return (
    <div style={{ backgroundColor: 'white', padding: 35, borderRadius: 12 }}>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} sm={6}>
          ...
          <CustomFormLabel htmlFor="fs-uname" sx={{ mt: 3 }}>
            Username
          </CustomFormLabel>
        ...
        <Grid item xs={12} sm={6}>
          ...
          <CustomFormLabel htmlFor="fs-email" sx={{ mt: { sm: 3 } }}>
            Email
          </CustomFormLabel>
          <CustomOutlinedInput
