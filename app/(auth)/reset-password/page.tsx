...
export default function ResetPassword() {
  ...
  const handleFormData = async (values: any) => {
    ...
    const startIndex = windowUrl.indexOf('reset-password?') + 'reset-password?'.length;
  ...
  return (
    <>
      ...
      <Stack gap={1}>
        ...
        <Typography>Set a strong password to regain access to your Wateen account.</Typography>
      </Stack>
